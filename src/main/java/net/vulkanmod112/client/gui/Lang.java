 ...
 * {@code vulkanmod112.option.dynamic_lights}, and its description
 * {@code vulkanmod112.tooltip.dynamic_lights}. The English stays in the source
 ...
 * {@code -Dvulkanmod112.dumpLang=true}: it writes out every key the screen
...
public final class Lang {
    ...
    public static final String OPTION = "vulkanmod112.option.";
    public static final String TOOLTIP = "vulkanmod112.tooltip.";
    public static final String APPLIES = "vulkanmod112.applies.";
    public static final String PAGE = "vulkanmod112.page.";
    public static final String GROUP = "vulkanmod112.group.";
    public static final String VALUE = "vulkanmod112.value.";
    public static final String UNIT = "vulkanmod112.unit.";
    public static final String COST = "vulkanmod112.cost.";
    public static final String UI = "vulkanmod112.ui.";
     ...
     * {@code -Dvulkanmod112.dumpLang=true} and compare.
     */
