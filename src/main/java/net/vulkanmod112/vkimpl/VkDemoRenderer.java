...
final class VkDemoRenderer {
    ...
    private static final Logger LOGGER = LogManager.getLogger("VulkanMod112/Demo");
    ...
    private void createPipeline() {
        try (MemoryStack stack = stackPush()) {
            long vertModule = createShaderModule(stack, "vulkanmod112/shaders/demo.vert.spv");
            long fragModule = createShaderModule(stack, "vulkanmod112/shaders/demo.frag.spv");
