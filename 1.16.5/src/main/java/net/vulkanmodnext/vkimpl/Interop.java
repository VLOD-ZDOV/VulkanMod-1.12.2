...
final class Interop {
    ...
    static long appendWin32MemoryRights(MemoryStack stack, long exportInfo) {
        ...
        org.lwjgl.vulkan.VkExportMemoryWin32HandleInfoKHR rights =
                org.lwjgl.vulkan.VkExportMemoryWin32HandleInfoKHR.callocStack(stack)
    ...
    static long appendWin32SemaphoreRights(MemoryStack stack, long exportInfo) {
        ...
        org.lwjgl.vulkan.VkExportSemaphoreWin32HandleInfoKHR rights =
                org.lwjgl.vulkan.VkExportSemaphoreWin32HandleInfoKHR.callocStack(stack)
    ...
    private static long closeHandleFunction() {
        ...
        if (closeHandleAddress == 0L) {
            try {
                closeHandleAddress = APIUtil.apiCreateLibrary("kernel32").getFunctionAddress("CloseHandle");
            } catch (Throwable t) {
    ...
    static void requireSameDevice(VkPhysicalDevice physicalDevice, int vulkanDeviceCount) {
        try (MemoryStack stack = push()) {
            VkPhysicalDeviceIDProperties idProps = VkPhysicalDeviceIDProperties.callocStack(stack)
                    .sType(VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES);
            VkPhysicalDeviceProperties2 props = VkPhysicalDeviceProperties2.callocStack(stack)
        ...
        try (MemoryStack stack = push()) {
            ...
            for (int i = 0; i < handleTypes.length; i++) {
                VkPhysicalDeviceExternalSemaphoreInfo info =
                        VkPhysicalDeviceExternalSemaphoreInfo.callocStack(stack)
                                .sType(VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO)
                                .handleType(handleTypes[i]);
                VkExternalSemaphoreProperties props = VkExternalSemaphoreProperties.callocStack(stack)
    ...
    static int importMemoryToGL(MemoryStack stack, VkDevice device, long memory, long size,
        ...
        if (WINDOWS) {
            VkMemoryGetWin32HandleInfoKHR info = VkMemoryGetWin32HandleInfoKHR.callocStack(stack)
    ...
    static int importSemaphoreToGL(MemoryStack stack, VkDevice device, long semaphore) {
        ...
        if (WINDOWS) {
            VkSemaphoreGetWin32HandleInfoKHR info = VkSemaphoreGetWin32HandleInfoKHR.callocStack(stack)
            ...
            VkSemaphoreGetFdInfoKHR info = VkSemaphoreGetFdInfoKHR.callocStack(stack)
